...
# Where to find data
tf.app.flags.DEFINE_string('data_path', 'data/home/chunked/train_*', 'Path expression to tf.Example datafiles. Can include wildcards to access multiple datafiles.')
tf.app.flags.DEFINE_string('valid_path', 'data/home/chunked/test_*', 'Path expression to tf.Example validation datafiles. Can include wildcards to access multiple datafiles.')
tf.app.flags.DEFINE_string('vocab_path', 'data/home/vocab', 'Path expression to text vocabulary file.')
